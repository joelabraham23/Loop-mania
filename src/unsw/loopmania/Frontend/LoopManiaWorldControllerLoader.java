...
public class LoopManiaWorldControllerLoader extends LoopManiaWorldLoader {
    ...
    public LoopManiaWorldControllerLoader(String filename, String gameMode)
        ...
        super(filename, gameMode);
        entities = new ArrayList<>();
    }

    /**
     * Creates a character on the game screen
     * @param character character to create
     */
    @Override
    public void onLoad(Character character) {
        addEntity(character, character.getCurrentImageView());
    }

    /**
     * Creates a building on the game screen
    ...
    public void onLoad(PathTile pathTile, PathTile.Direction into, PathTile.Direction out) {
        ...
        Image pathTileView = turnStringToImage(pathTile.getEntityImageString());
        ImageView view = new ImageView(pathTileView);
        int x;
        int y;
